...
Read `.claude/skills/start-therapy-session/rules/knowledge-gap-analysis.md` and execute the full procedure:
...
Read `.claude/skills/start-therapy-session/rules/intake-questions.md` for the exact question wording, delivery rules,
...
Read `.claude/skills/start-therapy-session/rules/informed-consent.md` (scripts from the psychotherapist agent's
...
Read `.claude/skills/start-therapy-session/rules/handoff-prompt.md` for the dispatch template. Assemble the prompt
...
by adopting the psychotherapist agent's persona and methodology (see `.claude/agents/psychotherapist.md`).
...
Read `.claude/skills/start-therapy-session/rules/session-note-format.md` for the note template and procedure. Write
...
Read `.claude/skills/start-therapy-session/rules/compression-rules.md` and apply all rules to the history file.
