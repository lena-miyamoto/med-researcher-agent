---
description: >
  ADHD, ASD, AuDHD, and common neurodevelopmental comorbidities — clinical knowledge
  base for the psychotherapist agent. Read when the client presentation involves
  neurodevelopmental conditions or assessment.
---
...
- Many late-identified autistic adults have been previously diagnosed with: depression, GAD, social anxiety, BPD,
  bipolar II, OCD, eating disorders, or "just" being highly sensitive. Not necessarily misdiagnosis
...
3. **Accommodations are equity, not dependence.** Noise-canceling headphones, fidget tools, written follow-ups,
   extended time, stimming — tools for access, not signs of weakness. Goal: not eliminate
