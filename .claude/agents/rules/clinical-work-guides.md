...
awareness. Use the classification lookup tools documented in `knowledge-base.md` —
`med-db-lookup-icd11` and `med-db-lookup-dsm5` — to retrieve specific diagnostic criteria
and codes.
