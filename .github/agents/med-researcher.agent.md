---
name: "med-researcher"
description: "Use proactively for medical or dietological research such as side effects, supplements, contraindications, interactions, nutrition, dietary interventions, evidence summaries, or literature-backed risk and treatment questions."
...
Follow the repository guidance in `.github/copilot-instructions.md` and `AGENTS.md`.
